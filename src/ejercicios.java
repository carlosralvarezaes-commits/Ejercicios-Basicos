...
//for (int bloquespicados = 1 ; bloquespicados <= numerodebloques; bloquespicados++ ){System.out.println("Picando bloque:" + bloquespicados);}
//
//
//        //2
...
//        while (Saldo < Precio){System.out.println("Saldo insuficiente"); Saldo = lector.nextDouble();}
//        if (Saldo == Precio){System.out.println("Saldo Alcanza"); }
//        if (Saldo > Precio){System.out.println("Saldo Sobra"); }
//
...
//3
        ...
        }if (vida < 0 && enemigo < 0) {System.out.println("Vida negativo");}
...
//        int suma = A + B;
//
//        System.out.print("Resultado de tu suma:"+ X);
